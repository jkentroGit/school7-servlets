...
<span class="card-header text-xl-center text-lg bg-info"> Eπεξεργασία καθηγητή </span>
  ...
  <div class="card-body p-0 col-0 text-center mt-5">
    <div class=" mb-5  mx-auto">
      <form class="w-10 mx-auto d-flex flex-column" method="POST" action="${pageContext.request.contextPath}/school-app/teachers/update">
              ...
              <div class="input-group container mb-3">
                <label class="input-group-text col-3">ΑΦΜ</label>
                  <input class="form-control" type="text" name="vat" value="${requestScope.updateDTO.vat}" placeholder="ΑΦΜ"></input>
