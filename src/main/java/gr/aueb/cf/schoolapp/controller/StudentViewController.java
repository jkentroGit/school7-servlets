...
public class StudentViewController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        try {
            ...
            req.getRequestDispatcher("/WEB-INF/jsp/teacher-viewone.jsp").forward(req, resp);
        } catch (SQLException | TeacherDAOException | TeacherNotFoundException e) {
            String errorMessage = e.getMessage();
            req.setAttribute("errorMessage", errorMessage);
            req.getRequestDispatcher("/WEB-INF/jsp/teacher-viewone.jsp")
                    .forward(req, resp);
        }
    }
...
//                        .forward(req, resp);
                resp.sendRedirect(req.getContextPath() + "/school-app/teachers/viewone?id=" + id);
                return;
            }
