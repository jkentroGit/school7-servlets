...
public class StudentViewController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        try {
            ...
            req.getRequestDispatcher("/WEB-INF/jsp/student-viewone.jsp").forward(req, resp);
        } catch (SQLException | StudentDAOException | StudentNotFoundException e) {
            String errorMessage = e.getMessage();
            req.setAttribute("errorMessage", errorMessage);
            req.getRequestDispatcher("/WEB-INF/jsp/student-viewone.jsp")
                    .forward(req, resp);
        }
    }
...
//                        .forward(req, resp);
                resp.sendRedirect(req.getContextPath() + "/school-app/students/viewone?id=" + id);
                return;
            }
